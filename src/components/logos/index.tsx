...
export function ConvexLogo(props: LogoProps): React.ReactElement {
  return (
    <svg viewBox="0 0 256 256" fill="none" {...props}>
      <path d="M128 12C62.8 12 10 64.8 10 130c0 30.2 11.4 57.7 30.1 78.5 3.3-25.4 18.3-47.6 40-60.3-9.8-12.5-15.6-28.2-15.6-45.2 0-40.3 32.7-73 73-73 14.9 0 28.8 4.5 40.3 12.2l35.7-20.6C192.8 6.1 166.8-3.7 138.6.9 134.4 1.5 131.2 2.5 128 3.9V12z" fill="#8B5CF6"/>
      <path d="M246 130c0-30.2-11.4-57.7-30.1-78.5-3.3 25.4-18.3 47.6-40 60.3 9.8 12.5 15.6 28.2 15.6 45.2 0 40.3-32.7 73-73 73-14.9 0-28.8-4.5-40.3-12.2l-35.7 20.6c20.7 15.5 46.7 25.3 74.9 20.7 4.2-.6 7.4-1.6 10.6-3V248C193.2 248 246 195.2 246 130z" fill="#FBBF24"/>
      <path d="M175.9 111.8c21.7 12.7 36.7 34.9 40 60.3 18.7-20.8 30.1-48.3 30.1-78.5V93c0-20.7-5-40.2-13.8-57.4l-35.7 20.6c11.7 16.5 18.5 36.7 18.5 58.4 0 18.4-4.9 35.6-13.5 50.5-17.4-10.2-31.7-25.2-40.3-43.5l14.7-9.8z" fill="#EF4444"/>
    </svg>
  );
}
